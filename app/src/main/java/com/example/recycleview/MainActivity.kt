...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textId = resources.getStringArray(R.array.chelik)
        textBonkId = resources.getStringArray(R.array.opisanie)
    ...
    data class DataClass(var titleImage : Int , var heading : String ,var bonktxt
    : String)
    class MyAdapter(private val newList : ArrayList<DataClass>) :
        ...
        override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
            ...
            holder.itemView.setOnClickListener {
                if (position == 0) {
                    Toast.makeText(holder.itemView.context, "Мы нажали на 1 элемент!",
